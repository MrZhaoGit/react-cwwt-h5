          ...
          <li>
            ...
            >
              <InputItem
                ...
                placeholder="请选择入住城市"
                onClick={this.selectCityFn.bind(this, "hotelCity")}
                editable = {false}
              />
              <div 
                className={ this.state.hotelCity.cityName === "" ? "currentCity" : "currentCity hasCurrentCity"}
                onClick={this.getCurrentCityFn.bind(this)}
              >
                <img src={this.state.hotelCity.cityName === ""? noPositioningIcon: positioningIcon} alt="" />
                我的位置
              </div>
            </Flex>
          </li>
